"""
Django settings for dj_adm project.
...
MIDDLEWARE = [
    ...
    "dj_adm.middleware.StatsMiddleware",
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "dj_adm.context_processors.settings",
            ]
        },
    }
]
...
WSGI_APPLICATION = "dj_adm.wsgi.application"
